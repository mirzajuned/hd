json.array!(@patient_ophthal_investigations) do |patient_ophthal_investigation|
  json.extract! patient_ophthal_investigation, :id, :created_at, :doctor_name, :facility_id, :patient_id, :record_id, :specalityid, :specalityname, :templatetype, :user_id, :status, :payment
