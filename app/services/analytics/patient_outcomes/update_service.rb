        ...
        if ipd_record_data.present? && procedure_list_data.present?
          ...
          procedure_list_data.each_with_index do |procedure, indx|
            if cornea_procedures_hash.key?(procedure.try(:procedure_id)) || cataract_procedures_hash.key?(procedure.try(:procedure_id))
              ...
              patient_outcome   = Analytics::Ophthalmology::PatientSurgicalOutcome.find_by(
              ...
              if patient_outcome.present? && operative_note.present?
                ...
                if after_surgery.present? && before_surgery.present?
                  ...
                  patient_surgical_outcome = patient_outcome
                  ...
                  patient_surgical_outcome[:uncorrected_va_pre_surgery_percentage_left_near] = 0.0
                  ...
                  patient_surgical_outcome[:uncorrected_va_pre_surgery_percentage_left_far] = 0.0
                  ...
                  patient_surgical_outcome[:bestcorrected_va_post_surgery_percentage_left_near] = 0.0
                  ...
                  patient_surgical_outcome[:bestcorrected_va_post_surgery_percentage_left_far] = 0.0
                  ...
                  patient_surgical_outcome[:uncorrected_va_pre_surgery_percentage_right_near] = 0.0
                  ...
                  patient_surgical_outcome[:uncorrected_va_pre_surgery_percentage_right_far] = 0.0
                  ...
                  patient_surgical_outcome[:bestcorrected_va_post_surgery_percentage_right_near] = 0.0
                  ...
                  patient_surgical_outcome[:bestcorrected_va_post_surgery_percentage_right_far] = 0.0
