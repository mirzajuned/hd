module Analytics::PartialData
  class DoctorData
    class << self
      def facility_wise_doctor_ophthal_investigations(params_hash = {})
      ...
      def facility_wise_doctor_laboratory_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date = Date.parse(start_date)
      ...
      def facility_wise_doctor_radiology_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date = Date.parse(start_date)
      ...
      def top_ten_doctor_ophthal_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
      ...
      def top_ten_doctor_laboratory_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def top_ten_doctor_radiology_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def ophthal_doctor_investigation_data(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
      ...
      def laboratory_doctor_investigation_data(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def radiology_doctor_investigation_data(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def age_wise_doctor_ophthal_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def age_wise_doctor_laboratory_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def age_wise_doctor_radiology_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
