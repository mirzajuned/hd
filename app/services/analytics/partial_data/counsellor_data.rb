module Analytics::PartialData
  class CounsellorData
    class << self
      def facility_wise_counsellor_ophthal_investigations(params_hash = {})
        ...
        match_with_this = {
          ...
          'user_role_ids' => { '$in' => [499992366, '$user_role_ids'] }
        }
      ...
      def facility_wise_counsellor_laboratory_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date = Date.parse(start_date)
      ...
      def facility_wise_counsellor_radiology_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date = Date.parse(start_date)
      ...
      def top_ten_counsellor_ophthal_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
      ...
      def top_ten_counsellor_laboratory_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def top_ten_counsellor_radiology_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def ophthal_counsellor_investigation_data(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
      ...
      def laboratory_counsellor_investigation_data(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
        ...
        labels = investigation_data.pluck(:investigation_name).map(&:to_s).map(&:upcase)
        data = investigation_data.pluck(:count)
        data = [0, 0, 0, 0, 0] unless data.present?
        [labels, data]
      end

      def radiology_counsellor_investigation_data(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def age_wise_counsellor_ophthal_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def age_wise_counsellor_laboratory_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
      ...
      def age_wise_counsellor_radiology_investigations(params_hash = {})
        label_on = params_hash['label_on']
        match_with_this2 = params_hash['data_query'].delete_if { |k| k == {} }
        organisation_id, facility_id, specialty_id, start_date, end_date = fetch_params_hash(params_hash)
        start_date, end_date, group_by = set_initial_params(start_date, end_date, facility_id)
