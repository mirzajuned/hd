class CustomRadiologyInvestigations::UpdateRadiologyInvService
  def self.call(inv_id, params, current_user)
    @investigation = CustomRadiologyInvestigation.find_by(id: inv_id)
    ...
    @investigation = @investigation.update_attributes(custom_rad_update_params(params))
  end
  ...
  def self.custom_rad_update_params(params)
