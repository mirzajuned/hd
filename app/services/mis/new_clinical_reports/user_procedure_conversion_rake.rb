module Mis::NewClinicalReports
  class UserProcedureConversionRake
    class << self
      def call(start_date, end_date, organisation_id)
        ...
        facilities = Organisation.find_by(id: organisation_id)&.facilities || []
          ...
          (start_date.to_date..end_date.to_date).each do |date|
            ...
            loop_in_keys.each do |user_id|
              ...
              if user.present?
                ...
                procedure_details = MisClinical::Common::UserProcedureConversion.find_or_create_by(
                  procedure_date: date, facility_id: facility_id, user_id: user_id
                )
                ...
                procedure_details.time_performed_by_other = time_performed_by_other
        ...
        mis_logger.info(" === Error in Common UserProcedureConversionRake: #{e.inspect}")
      end
      ...
      def aggregation_total_advised(start_date, end_date, facility_id, organisation_id)
        ...
        performed_condition = { "performed_time": { '$gte' => start_date, '$lte' => end_date } }
      ...
      def project_options
        {
          ...
          is_advised: 1, is_converted: 1, is_performed: 1, has_declined: 1,
          advised_by: 1, advised_by_id: 1, performed_by: 1, performed_by_id: 1,
          organisation_id: 1, facility_id: 1, conversion_time_days: 1
        }
      end
