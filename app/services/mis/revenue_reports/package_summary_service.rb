  ...
  class PackageSummaryService
    class << self
      ...
      def generate_table_data(service)
        ...
        discount_percentage = (service['discount_percentage'].present?) ? service['discount_percentage'].round(2) : 'NA'
        ...
        if @request == 'json'
          ...
          t_data = [service_details, bill_details, i_type, payer_details, sub_specialty_name, 
                    ...
                    service['invoice_unit_price'], service['unit_cost_difference'], 
          ...
          t_data = [service_name, service_created, invoice_number, invoice_created, 
                    ...
                    service['unit_cost_difference'], service['discount_amount'], 
