      ...
      def generate_table_data(patient_presciption)
        ...
        if @request == 'json'
          ...
          t_data = [
            ...
            patient_address, advised_by_details, converted_by_details, total_offer,
            bill_details, bill_status, invoice_total, discount, invoice_tax, invoice_gross, conversion_in_days
           ]
        else
          t_data = [
            ...
            converted_by_name, converted_on, converted_at, bill_no, bill_status, 
            invoice_total, discount, total_offer, invoice_tax, invoice_gross, conversion_in_days
          ]
        end
