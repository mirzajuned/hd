module Mis::ClinicalReports
  class RadiologyCounsellorWiseService
    class << self
      ...
      def group_options
        {
          _id: { counselled_by_id: '$radiology_investigations.counselled_by_id' },
          investigation_state_list: {
            "$push": { counselled_by: '$radiology_investigations.counselled_by',
                       is_counselled: '$radiology_investigations.is_counselled',
      ...
      def project_options
        {
          ...
          'radiology_investigations.counselled_by_id': 1,
          'radiology_investigations.is_counselled': 1,
