module Mis::ClinicalReports
  class OphthalConversionWiseService
    class << self
      ...
      def group_options
        {
          _id: '$dayMonthyearUTC', investigation_state_list: {
            "$push":
            {
              ...
              has_agreed: '$ophthal_investigations.has_agreed',
              has_declined: '$ophthal_investigations.has_declined',
              payment_taken: '$ophthal_investigations.payment_taken',
      ...
      def project_options
        {
          dayMonthyearUTC: {
            '$dateToString': { format: '%d-%m-%Y', date: '$ophthal_investigations.advised_datetime' }
          },
