module Mis::ClinicalReports
  class RadiologyDoctorWiseService
    class << self
      ...
      def group_options
        {
          _id: { advised_by_id: '$radiology_investigations.advised_by_id' },
          procedure_state_list: {
            "$push": { advised_by: '$radiology_investigations.advised_by',
      ...
      def project_options
        {
          ...
          'radiology_investigations.advised_by_id': 1,
