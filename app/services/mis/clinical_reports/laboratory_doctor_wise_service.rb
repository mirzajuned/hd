module Mis::ClinicalReports
  class LaboratoryDoctorWiseService
    class << self
      ...
      def make_anchor_url(status_wise_count, doctor_id)
        ...
        if @request == 'json'
          ...
          advised_count, declined_count, performed_count = anchored_count(status_wise_count, doctor_id, href)
        end
        [advised_count, declined_count, performed_count]
      end

      def anchored_count(status_wise_count, doctor_id, href)
        declined_count, performed_count, advised_count = status_wise_count
        if advised_count > 0
      ...
      def group_options
        {
          _id: { advised_by_id: '$laboratory_investigations.advised_by_id' },
          procedure_state_list: {
            "$push": {  advised_by: '$laboratory_investigations.advised_by',
      ...
      def project_options
        {
          ...
          'laboratory_investigations.advised_by_id': 1,
