module Mis::ClinicalReports
  class OphthalDoctorWiseService
    class << self
      ...
      def make_anchor_url(status_wise_count, doctor_id)
        ...
        if @request == 'json'
          ...
          declined_count, performed_count, advised_count = anchored_url(status_wise_count, href, doctor_id)
        end
        [advised_count, declined_count, performed_count]
      end

      def anchored_url(status_wise_count, href, doctor_id)
        declined_count, performed_count, advised_count = status_wise_count
        if advised_count > 0
      ...
      def group_options
        {
          _id: { advised_by_id: '$ophthal_investigations.advised_by_id' },
          procedure_state_list: {
            "$push": { advised_by: '$ophthal_investigations.advised_by',
                       is_advised: '$ophthal_investigations.is_advised',
      ...
      def project_options
        {
          ...
          'ophthal_investigations.advised_by_id': 1,
