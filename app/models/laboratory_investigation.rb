class LaboratoryInvestigation
  ...
  embeds_many :laboratory_panel_records, :class_name => 'EhrInvestigation::PanelRecord'

  index({order_item_advised_id: 1})

  accepts_nested_attributes_for :laboratory_panel_records, :class_name => 'EhrInvestigation::PanelRecord'
end
