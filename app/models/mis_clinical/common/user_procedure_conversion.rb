class MisClinical::Common::UserProcedureConversion
  ...
  field :user_role_id, type: String #adviced by user role
  field :user_role_name, type: String #adviced by user role name
