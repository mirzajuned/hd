class MisClinical::Common::PatientProcedureWise
  ...
  # field :record_id, type: BSON::ObjectId #appointment, admission, ot_schedule
  # field :record_type, type: String #appointment, admission, ot_schedule
  field :record_id, type: BSON::ObjectId #opd_record_id, ...
  field :ipd_record_id, type: BSON::ObjectId #opd_record_id, ...
  field :entered_from, type: String #opd_record, ipd_record, ot
...
# db.finance_report_data.createIndex({"case_sheet_procedure_id": 1, "case_sheet_id": 1, "facility_id": 1 });