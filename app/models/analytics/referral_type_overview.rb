class Analytics::ReferralTypeOverview
  ...
  field :referral_type_id, type: BSON::ObjectId
  field :referral_type_count, type: Integer, default: 0
  field :referral_type_label, type: String
