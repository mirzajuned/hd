class Inventory::Item::Optical::Contact < Inventory::Item
  include Mongoid::Document

  field :item_type, type: String, default: 'contact'
  ...
  def self.build_with_custom_field(*_args)
    item = new
    custom_field = [{ name: 'Replacement', value: ['monthly', 'quarterly'] },
                    { name: 'Wearing period', value: ['daily', 'extended'] }]
