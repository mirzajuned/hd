class TranslatedIcdDiagnosis
  ...
  field :separated_code, type: String # in case icd is children
  ...
  field :icd_type, type: String, default: :TranslatedIcdDiagnosis
  ...
  field :translated_language, type: String
  field :facility_ids, type: String
