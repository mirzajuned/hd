class OpdRecords::GeneralMedicineNotesController < OpdRecordsController
  ...
  def new
    ...
    @url_path = "opd_records_general_medicine_notes_path"
    @url_method = "post"
    super
  end
  ...
  def edit
    ...
    @url_path = "opd_records_general_medicine_note_path"
    @url_method = "patch"
