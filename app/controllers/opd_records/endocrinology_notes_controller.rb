class OpdRecords::EndocrinologyNotesController < OpdRecordsController
  ...
  def new
    ...
    @url_path = "opd_records_endocrinology_notes_path"
    @url_method = "post"
    super
  end
  ...
  def edit
    ...
    @url_path = "opd_records_endocrinology_note_path"
    @url_method = "patch"
