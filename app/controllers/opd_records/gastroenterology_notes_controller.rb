class OpdRecords::GastroenterologyNotesController < OpdRecordsController
  ...
  def new
    ...
    @url_path = "opd_records_gastroenterology_notes_path"
    @url_method = "post"
    super
  end
  ...
  def edit
    ...
    @url_path = "opd_records_gastroenterology_note_path"
    @url_method = "patch"
