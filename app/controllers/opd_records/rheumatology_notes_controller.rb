class OpdRecords::RheumatologyNotesController < OpdRecordsController
  ...
  def new
    ...
    @url_path = "opd_records_rheumatology_notes_path"
    @url_method = "post"
    super
  end
  ...
  def edit
    ...
    @url_path = "opd_records_rheumatology_note_path"
    @url_method = "patch"
