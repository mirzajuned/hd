class OpdRecords::ObstetricsGynecologyNotesController < OpdRecordsController
  ...
  def new
    ...
    @url_path = "opd_records_obstetrics_gynecology_notes_path"
    @url_method = "post"
    super
  end
  ...
  def edit
    ...
    @url_path = "opd_records_obstetrics_gynecology_note_path"
    @url_method = "patch"
