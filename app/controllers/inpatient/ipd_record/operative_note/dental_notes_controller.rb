class Inpatient::IpdRecord::OperativeNote::DentalNotesController < Inpatient::IpdRecord::OperativeNotesController
  before_action :specialty_params

  def new
    @url_path = "inpatient_ipd_record_operative_note_dental_notes_path"
  ...
  def edit
    @url_path = "inpatient_ipd_record_operative_note_dental_note_path"
