class Analytics::FinancialsController < ApplicationController
  ...
  def get_analytics_filters
    ...
    facility_currency_ids = facility.currency_ids + [facility.currency_id]
    @facility_currencies = Currency.where(:id.in => facility_currency_ids)
    @currency_id = params[:currency_id] || facility.try(:currency_id) || current_facility.currency_id
